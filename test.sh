...
command="./git-url.sh test-files/example.txt"
...
command="./git-url.sh -l 5 test-files/example.txt"
...
command="./git-url.sh -b test-files/example.txt"
...
command="./git-url.sh -b -l 5 test-files/example.txt"
...
command="./git-url.sh 'test-files/¬\`!£$%^&()-_=+[]{};'\''@#~, .txt'"
...
command="./git-url.sh 'test-files/<>:\"\\|?*.txt'"
